        ...
        <div className='flex flex-col justify-between items-center min-h-screen'>
            ...
            <div className='flex flex-col gap-11 p-10 w-90'>
                <div className='flex flex-col gap-6'>
                    ...
                    <Link className='shadow montserrat-semi-bold rounded-2xl py-5 text-xl text-center bg-[#F6BA00]' to={'app/register'} >Начать</Link>
                </div>
                <div className='flex flex-col gap-6'>
                    ...
                    <Link className='shadow montserrat-semi-bold rounded-2xl py-5 text-xl text-center bg-[#F6BA00]' to={'app/login'} >Войти</Link>
                </div>
            </div>
